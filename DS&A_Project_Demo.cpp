...
// here guys I have problem in catching the crn to show all the student who have the same crn
void Search_crn(int crn)
{
    // if head is NULL
    if (!head) {
        cout << "No such Record "
...
int main()
{
    ...
    while (true) {
        ...
        if (Choice == 1) {
            ...
            cout << "Enter the  CRN number of the student  "
                    "CRN you want to Search\n";
            cin >> crn;
        Search_crn(int crn);
